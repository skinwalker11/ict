...
bot = Client(
    ...
    bot_token="5520140948:AAGDm4Xr9oOGRfeFuOHHSIORbK5jv7p6oJw"
...
A0001_BUTTONS=[
    ...
    [InlineKeyboardButton('VIDEO LESSONS : E-Learnlk',url='https://e-learnlk.eu.org')],
    [InlineKeyboardButton('⬅️BACK',callback_data='MAIN')],
    [InlineKeyboardButton('❌CLOSE❌',callback_data='CLOSE')],
]
#more
A0003_BUTTONS=[
    [InlineKeyboardButton('Contact admin or ask your questions here',callback_data='contact')],
    [InlineKeyboardButton('➕ADD TO GROUP➕',url='http://t.me/grpmenubot?startgroup=botstart')],
    [InlineKeyboardButton('⬅️BACK',callback_data='MAIN')],
    [InlineKeyboardButton('❌CLOSE❌',callback_data='CLOSE')],
]
contact_buttons=[
    [InlineKeyboardButton('Phantom Helper Bot',url='https://t.me/phantomhelperbot?start=start')],
    [InlineKeyboardButton('⬅️BACK',callback_data='MAIN')],
    [InlineKeyboardButton('❌CLOSE❌',callback_data='CLOSE')]
]
#ict
...
#BIO
A0007_BUTTONS=[
    [InlineKeyboardButton('ABOUT SUBLECT',callback_data='BA')],
    [InlineKeyboardButton('⬅️BACK',callback_data='A0001'),InlineKeyboardButton('START MENU',callback_data='MAIN')],
    [InlineKeyboardButton('❌CLOSE❌',callback_data='CLOSE')],
]
A0008_BUTTONS=[
...
PH0001_BUTTONS=[
    ...
    [InlineKeyboardButton('GO BACK',callback_data='A0006'),InlineKeyboardButton('SUBJECT MENU',callback_data='A0001')],
    [InlineKeyboardButton('START MENU',callback_data='MAIN')],
    [InlineKeyboardButton('CLOSE',callback_data='CLOSE')],
]
